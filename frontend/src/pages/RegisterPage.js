            ...
            <div className="container mx-auto px-6">
                <div className="bg-white rounded-lg shadow-xl flex flex-col md:flex-row max-w-4xl mx-auto overflow-hidden">
                    <div className="md:w-1/2 p-8 flex-col justify-center items-center hidden md:flex">
                        <img src="https://placehold.co/400x400/EBF4FF/737373?text=Join\nUs!" alt="Register Illustration" className="rounded-lg" />
                    </div>
                    <div className="md:w-1/2 p-8 bg-orange-50 flex flex-col justify-center">
                        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">Register</h2>
                        <form>
                            <div className="mb-4">
                                <input type="text" placeholder="Username" className="w-full px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500" required />
                            </div>
                            <div className="mb-4">
